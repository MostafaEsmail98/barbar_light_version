...
class LanguageAr extends BaseLanguage {
  ...
  @override
  String get gallery => 'صور من أعمالي';
  ...
  String get newPasswordsMustBeDifferent =>
      'يجب أن تكون كلمات المرور الجديدة مختلفة عن الكلمات السابقة';
  ...
  @override
  String get signInToReserve => 'الرجاء تسجيل الدخول للحجز';
  ...
  String get yourAccountIsReady =>
      'حسابك جاهز للاستخدام. استمتع بمتخصصينا وخدماتنا';
  ...
  @override
  String get reviews => 'اراء المستخدمين';

  @override
  String get staff => 'الحلاقين';
  ...
  String get theUserHasDeniedSpeechRecognition =>
      'رفض المستخدم استخدام التعرف على الكلام';
  ...
  String get weProvideYouBestServiceMessage =>
      'نحن نقدم لك أفضل الخدمات وأفضلها';
  ...
  String get timeSlotBookedMessage =>
      'تم حجزه بالفعل! الرجاء اختيار فترة زمنية أخرى';
  ...
  String get walkThrough2subTitle =>
      'يمكنك اختيار الخدمة الخاصة بك واختيار المختص الخاص بك والحصول على الحجز السريع';
  ...
  String get walkThrough3subTitle =>
      'يمكنك الحصول على أفضل الخدمات وأفضل متخصص في خدماتك لدينا';
  ...
  String get termsConditionsMessage =>
      'لقد قرأت إخلاء المسؤولية وأوافق على الشروط والأحكام';
  ...
  String get noStaffAvailableForBranchMessage =>
      'لا يوجد موظفين متاحين للخدمة المختارة!';
  ...
  @override
  String get yourBookingForHairBookingMessage => 'لقد تم تأكيد الحجز        ';
  ...
  String get bookingTimeSlotChangeMessage =>
      'هل تريد تغيير الفترة الزمنية لهذا الحجز؟';
  ...
  String get anUpdateToIs =>
      'يتوفر تحديث لتطبيق $APP_NAME. انتقل إلى متجر Play وقم بتنزيل الإصدار الجديد من التطبيق.';
  ...
  String get thereAreNoBookings =>
      'لا توجد حجوزات مدرجة في الوقت الراهن. تتبع الحجوزات الخاصة بك هنا.';
  ...
  String get thereAreNoCategories =>
      'لا توجد فئات في الوقت الراهن. تتبع الفئات الخاصة بك هنا.';
  ...
  String get accessDeniedContactYourAdmin =>
      'تم الرفض. اتصل بالمسؤول للحصول على المساعدة.';
  ...
  String get incorrectPinHasBeen =>
      'لقد تم إدخال رقم التعريف الشخصي بشكل غير صحيح';
  ...
  @override
  String get enterYourCode => 'ادخل كوبون الخصم';
  ...
  String get exclusiveYearLongSalonPamper =>
      'باقة تدليل الصالون الحصرية لمدة عام كامل';
  ...
  String get firstNameIsEmpty => "الاسم الاول فارغ";

  @override
  // TODO: implement lastNameIsEmpty
  String get lastNameIsEmpty => "الاسم الاخير فارغ";

  @override
  // TODO: implement passwordIsEmpty
  String get passwordIsEmpty => "كلمة السر فارغة";

  @override
  // TODO: implement phoneIsEmpty
  String get phoneIsEmpty => "رقم الهاتف فارغ";

  @override
  // TODO: implement phoneNumber
  String get phoneNumber => "رقم الهاتف";

  String get phoneNumberWithCountryCode => "رقم الهاتف مع كود الدولة";

  @override
  // TODO: implement reserveByPhone
  String get reserveByPhone => "الحجز عن طريق الهاتف";

  @override
  // TODO: implement ourBranches
  String get ourBranches => "أفرعنا";
  ...
  String get showLocationOnMap => "عرض الموقع على الخريطة";

  @override
  // TODO: implement useCoupon
  String get useCoupon => "استخدم كود";
  ...
  String get reserveNow => "احجز الان";

  @override
  // TODO: implement showProfile
  String get showProfile => "عرض الملف الشخصي";
  @override
  String get reserveNearestTime => "الحجز بأقرب موعد";

  @override
  // TODO: implement availableReserveNow
  String get availableReserveNow => "متاح - احجز";
