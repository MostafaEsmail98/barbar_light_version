...
class LanguageEs extends BaseLanguage {
  ...
  String get phoneNumberWithCountryCode => "phoneNumber With CountryCode 962";
  ...
  String get createYourAccountFor =>
      'Cree su cuenta para una mejor experiencia';
  ...
  String get checkYourMailAnd =>
      'Revisa tu correo e ingresa el código que obtienes';
  ...
  String get aResetPasswordLink =>
      'Se enviará un enlace para restablecer la contraseña a la dirección de correo electrónico ingresada anteriormente';
  ...
  String get newPasswordsMustBeDifferent =>
      'Las nuevas contraseñas deben ser diferentes a las anteriores.';
  ...
  String get otpInvalidMessage =>
      'El código ingresado no es válido, inténtelo nuevamente.';
  ...
  String get appleSigInIsNotAvailable =>
      'Apple SignIn no está disponible para su dispositivo';

  @override
  String get emailAddressIsRequiredUpdateAppleAccount =>
      'Se requiere Dirección de correo electrónico. Actualice el correo electrónico en su cuenta Apple';
  ...
  String get yourAccountIsReady =>
      'Su cuenta está lista para usar. Disfrute de nuestro especialista y nuestros servicios';
  ...
  String get theUserHasDeniedSpeechRecognition =>
      'El usuario ha negado el uso del reconocimiento de voz.';
  ...
  String get weProvideYouBestServiceMessage =>
      'Le brindamos los mejores servicios y la mejor';
  ...
  String get timeSlotBookedMessage =>
      '¡Ya está reservado! Por favor elige otra franja horaria';
  ...
  String get walkThrough1subTitle =>
      'Puede encontrar fácilmente cerca de usted el mejor peluquero y salón y disfrutar de la mejor experiencia de servicio';
  ...
  String get walkThrough2subTitle =>
      'Puede elegir su servicio y elegir su especialista y obtener una reserva rápida.';
  ...
  String get walkThrough3subTitle =>
      'Obtendrá los mejores servicios y el mejor especialista de sus servicios de nuestro';
  ...
  String get deleteAccountConfirmation =>
      'Su cuenta será eliminada permanentemente. Sus datos no serán restaurados nuevamente.';
  ...
  String get termsConditionsMessage =>
      'He leído el aviso legal y acepto los términos y condiciones.';
  ...
  String get noStaffAvailableForBranchMessage =>
      '¡No hay personal disponible para el servicio seleccionado!';
  ...
  String get yourBookingForHairBookingMessage =>
      'Tu reserva de corte de pelo ha sido reservada con éxito.';
  ...
  String get demoUserCannotBeGrantedForThis =>
      'No se puede otorgar usuario de demostración para esta acción';
  ...
  String get yourPaymentIsPaidSuccessfullyMessage =>
      'Su pago se paga exitosamente con';
  ...
  String get bookingTimeSlotChangeMessage =>
      '¿Quieres cambiar la franja horaria de esta reserva?';
  ...
  String get oldPasswordDoesNotMatchMessage =>
      '¡Tu antigua contraseña no es correcta!';
  ...
  String get anUpdateToIs =>
      'Hay una actualización disponible para $APP_NAME. Vaya a Play Store y descargue la nueva versión de la aplicación.';
  ...
  String get thereAreNoBookings =>
      'No hay reservas publicadas en este momento. Realice un seguimiento de sus reservas aquí.';
  ...
  String get thereAreCurrentlyNoItems =>
      'Actualmente no hay artículos en su carrito. Comience a comprar y agregue artículos a su carrito.';
  ...
  String get looksLikeYouHave =>
      'Parece que aún no has agregado ninguna dirección.';
  ...
  String get thereAreNoOrders =>
      'No hay pedidos listados en este momento. Realice un seguimiento de sus pedidos aquí.';
  ...
  String get ourMostLoveChewTreats =>
      'Nuestras golosinas masticables más amorosas';
  ...
  String get thereAreNoCategories =>
      'No hay categorías por el momento. Mantenga un registro de sus categorías aquí.';
  ...
  String get atThisTimeThere =>
      'En este momento, no hay productos o categorías disponibles.';
  ...
  String get chooseYourConvenientPayment =>
      'Elija su opción de pago conveniente.';
  ...
  String get thereAreCurrentlyNoItemsInYourWishlist =>
      'Actualmente no hay artículos en su lista de deseos. Comience a agregar elementos que le gusten y guárdelos para más adelante.';
  ...
  String get ciNetPayNotSupportedMessage =>
      'CinetPay no es compatible con tus monedas';

  @override
  String get totalAmountShouldBeMoreThan =>
      'El importe total debe ser superior a';

  @override
  String get totalAmountShouldBeLessThan =>
      'El importe total debe ser inferior a';

  @override
  String get yourPaymentFailedPleaseTryAgain =>
      'Tu pago falló, inténtalo de nuevo.';
  ...
  String get accessDeniedContactYourAdmin =>
      'Acceso denegado. Póngase en contacto con su administrador para obtener ayuda.';
  ...
  String get pleaseCheckThePayment =>
      'Por favor verifique que la solicitud de pago se envíe a su número.';
  ...
  String get theTransactionIsStill =>
      'La transacción aún se está procesando y se encuentra en estado ambiguo. Realice la consulta de transacción para obtener el estado de la transacción.';
  ...
  String get theUserHasExceeded =>
      'El usuario ha excedido el límite de transacciones permitido en su billetera';

  @override
  String get theAmountUserIs =>
      'La cantidad que el usuario intenta transferir es inferior a la cantidad mínima permitida';
  ...
  String get transactionInPendingState =>
      'Transacción en estado pendiente. Por favor verifique después de algún tiempo';

  @override
  String get userWalletDoesNot =>
      'La billetera del usuario no tiene suficiente dinero para cubrir el monto a pagar';
  ...
  String get thisIsAGeneric =>
      'Se trata de una negativa genérica que tiene varias causas posibles.';

  @override
  String get payeeIsAlreadyInitiated =>
      'El beneficiario ya está iniciado para la deserción, está prohibido o no está registrado en la plataforma Airtel Money';

  @override
  String get theTransactionWasTimed =>
      'Se agotó el tiempo de espera de la transacción.';
  ...
  String get xSignatureAndPayloadDid =>
      'La firma x y la carga útil no coinciden';

  @override
  String get encryptionKeyHasBeen =>
      'La clave de cifrado se ha obtenido correctamente';

  @override
  String get couldNotFetchEncryption =>
      'No se pudo recuperar la clave de cifrado';
  ...
  String get exceedsWithdrawalAmountLimitS =>
      'Excede el(los) límite(s) de monto de retiro / Límite de monto de retiro excedido';
  ...
  String get transactionNotPermittedTo =>
      'Transacción no permitida al beneficiario';
  ...
  String get successfullyFetchedEncryptionKey =>
      'Clave de cifrado obtenida correctamente';

  @override
  String get errorWhileFetchingEncryption =>
      'Error al obtener la clave de cifrado';
  ...
  String get exclusiveYearLongSalonPamper =>
      'Paquete exclusivo de cuidados de salón durante todo el año';
  ...
  String get iHaveReadThe =>
      'He leído el descargo de responsabilidad y acepto las ';

  @override
  String get theCouponAmountExceeds =>
      'El monto del cupón excede el precio del servicio.';
  ...
  @override
  // TODO: implement firstNameIsEmpty
  String get firstNameIsEmpty => throw UnimplementedError();

  @override
  // TODO: implement lastNameIsEmpty
  String get lastNameIsEmpty => throw UnimplementedError();

  @override
  // TODO: implement passwordIsEmpty
  String get passwordIsEmpty => throw UnimplementedError();

  @override
  // TODO: implement phoneIsEmpty
  String get phoneIsEmpty => throw UnimplementedError();
  ...
  @override
  // TODO: implement reserveByPhone
  String get reserveByPhone => throw UnimplementedError();

  @override
  // TODO: implement ourBranches
  String get ourBranches => throw UnimplementedError();

  @override
  // TODO: implement reserve
  String get reserve => throw UnimplementedError();

  @override
  // TODO: implement showLocationOnMap
  String get showLocationOnMap => throw UnimplementedError();

  @override
  // TODO: implement useCoupon
  String get useCoupon => throw UnimplementedError();
  ...
  String get expert => throw UnimplementedError();
  ...
  @override
  // TODO: implement reserveNow
  String get reserveNow => throw UnimplementedError();

  @override
  // TODO: implement showProfile
  String get showProfile => throw UnimplementedError();

  @override
  // TODO: implement availableReserveNow
  String get availableReserveNow => throw UnimplementedError();
  ...
  @override
  // TODO: implement confirmReservation
  String get confirmReservation => throw UnimplementedError();

  @override
  // TODO: implement reserveNearestTime
  String get reserveNearestTime => throw UnimplementedError();

  @override
  // TODO: implement reserved
  String get reserved => throw UnimplementedError();
  ...
  @override
  // TODO: implement selectTime
  String get selectTime => throw UnimplementedError();
