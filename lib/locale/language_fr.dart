...
class LanguageFr extends BaseLanguage {
  ...
  String get aResetPasswordLink =>
      "Un lien de réinitialisation du mot de passe sera envoyé à l'adresse e-mail saisie ci-dessus";
  ...
  String get otpInvalidMessage =>
      "Le code saisi n'est pas valide, veuillez réessayer";
  ...
  String get emailAddressIsRequiredUpdateAppleAccount =>
      "Adresse e-mail est nécessaire. Veuillez mettre à jour l'e-mail dans votre compte Apple";
  ...
  String get yourAccountIsReady =>
      'Votre compte est prêt à être utilisé. Profitez de notre spécialiste et de nos services';
  ...
  String get doWantToBookAppointment =>
      'Vous souhaitez prendre ce rendez-vous ?';
  ...
  String get weLlNotifyYouOnce =>
      'Nous vous informerons dès que nous aurons quelque chose pour vous';
  ...
  String get timeSlotBookedMessage =>
      'est déjà réservé ! Veuillez choisir un autre créneau horaire';
  ...
  String get termsConditionsMessage =>
      "J'ai lu la clause de non-responsabilité et j'accepte les termes et conditions";
  ...
  String get yourBookingForHairBookingMessage =>
      'Votre réservation pour une coupe de cheveux a été réservée avec succès';
  ...
  String get youCannotBookPrevious =>
      'Vous ne pouvez pas réserver les créneaux précédents';
  ...
  String get yourPaymentIsPaidSuccessfullyMessage =>
      'Votre paiement est effectué avec succès avec';
  ...
  String get bookingTimeSlotChangeMessage =>
      'Souhaitez-vous modifier le créneau horaire de cette réservation ?';
  ...
  String get anUpdateToIs =>
      "Une mise à jour de $APP_NAME est disponible. Accédez au Play Store et téléchargez la nouvelle version de l'application.";
  ...
  String get pleaseSelectTheDateFirst =>
      "Veuillez d'abord sélectionner la date";

  @override
  String get thereAreNoBookings =>
      'Il n’y a aucune réservation répertoriée pour le moment. Gardez une trace de vos réservations ici.';
  ...
  String get looksLikeYouHave =>
      "il semble que vous n'ayez pas encore ajouté d'adresse.";
  ...
  String get totalAmountShouldBeMoreThan =>
      'Le montant total doit être supérieur à';

  @override
  String get totalAmountShouldBeLessThan =>
      'Le montant total doit être inférieur à';
  ...
  String get exclusiveYearLongSalonPamper =>
      "Forfait exclusif de soins de salon d'un an";
  ...
  String get doYouWantTo =>
      'Voulez-vous supprimer ce package et continuer avec';
  ...
  String get iHaveReadThe =>
      "J'ai lu la clause de non-responsabilité et j'accepte les ";

  @override
  String get theCouponAmountExceeds =>
      'Le montant du coupon dépasse le prix du service';
