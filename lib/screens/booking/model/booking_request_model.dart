...
class BookingRequestModel {
  ...
  double get percentTaxAmount => taxPercentage
        ...
        if (bookingRequestStore.isCouponApplied) {
          return ((totalAmountWithCouponDiscount * p0.percent.validate()) /
              100);
        } else {
  ...
  num get totalCouponDiscount =>
      totalAmount * bookingRequestStore.couponDiscountPercentage / 100 +
      bookingRequestStore.finalDiscountCouponAmount;
  ...
  Map<String, dynamic> toJson({String? dateTime}) {
    ...
    if (bookingRequestStore.isCouponApplied)
      data['coupon_code'] = discountCouponCode;
