...
import 'package:frezka/components/default_user_image_placeholder.dart';
...
import 'package:frezka/screens/experts/shimmer/employee_detail_shimmer.dart';
                                      ...
                                      children: [
                                        Icon(Icons.star,
                                            ...
                                            color: getRatingBarColor(
                                                employeeData.ratingStar
                                                    .validate()
                                                    .toInt())),
                                        if (employeeData.totalReview
                                                .validate() >=
                                            1)
                                          Text(
                            ...
                            AppTextField(
                              ...
                              onTap: () async {
                                ...
                                if (date != null) {
                                  ...
                                  if (branchConfigurationCached!.slot
                                      .validate()
                                      .any((element) =>
                                          element.day ==
                                  ...
                                  if (selectDateCont.text.isNotEmpty) {
                                    String? time =
                                        await _showTimeSlotBottomSheet(context);

                                    if (time != null) {
                                      selectTimeCont.text = formatOnlyTime(
                                          context,
                                          startTime: time);
                                      timeFocus.nextFocus();
                                    }
                          ...
                          children: [
                            ...
                            AppButton(
                              ...
                              onTap: () {
                                    ...
                                    doIfLoggedIn(context, () {
                                      ...
                                      showDialog(
                                        ...
                                        builder: (BuildContext context) =>
                                          ...
                                          subTitle:
                                              locale.doYouWantToConfirmBooking,
                                ...
                                taxRequest.totalAmount >=
                                    taxRequest.totalCouponDiscount),
                          ],
                        ),
                      ],
                    ),
