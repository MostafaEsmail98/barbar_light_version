              ...
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    Text(
                      ' - ${bookingData.paymentMethod == 'cash' ? locale.cash : bookingData.paymentMethod == 'visa' ? locale.visa : locale.cliq}',
                      style: boldTextStyle(
                          color:
                              bookingData.status == BookingStatusConst.COMPLETED
                                  ? Colors.white
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      if (bookingData.serviceList.validate().isNotEmpty &&
                          bookingData.packages != null &&
                          bookingData.packages!.isEmpty)
                        Marquee(
                          directionMarguee: DirectionMarguee.oneDirection,
                          child: Text(
                      ...
                      if (bookingData.packages != null &&
                          bookingData.packages!.isNotEmpty)
                        Marquee(
                          directionMarguee: DirectionMarguee.oneDirection,
                          child: Text(
                            bookingData.packages
                                .validate()
                                .map((e) => e.packageName.validate())
                                .toList()
                                .join(', '),
                            style: secondaryTextStyle(),
                            maxLines: 1,
