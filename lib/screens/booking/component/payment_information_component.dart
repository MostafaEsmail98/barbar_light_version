...
class PaymentInformationComponent extends StatefulWidget {
  ...
  @override
  State<PaymentInformationComponent> createState() =>
      _PaymentInformationComponentState();
}

class _PaymentInformationComponentState
    extends State<PaymentInformationComponent> {
  bool isPackage = false;
  double subtotal = 0.0;

  void initState() {
    super.initState();
    if (widget.booking.packages != null &&
        widget.booking.packages!.isNotEmpty) {
      isPackage = widget.booking.packages!.isNotEmpty;
    }
    subtotal = isPackage
        ? widget.booking.sumOfPackagesPrices.validate() -
            widget.booking.couponAmount.validate().toDouble()
        : widget.booking.sumOfServicePrices.validate() -
            widget.booking.couponAmount.validate().toDouble();
  }
    ...
    return Column(
      children: [
        ViewAllLabel(
          ...
          labelTextStyle:
              secondaryTextStyle(color: Colors.white, weight: FontWeight.bold),
          isShowAll: false,
          onTap: () {
            //
          },
            ...
            children: [
              ...
              if (widget.booking.couponAmount.validate() != 0)
                SettingItemWidget(
                  ...
                  trailing: Marquee(
                      child: PriceWidget(
                          price: widget.booking.couponAmount.validate(),
                          color: Colors.red,
                ...
                SettingItemWidget(
                  ...
                  trailing: Marquee(
                    child: PriceWidget(
                        price: isPackage
                            ? widget.booking.sumOfPackagesPrices.validate() -
                                widget.booking.couponAmount.validate()
                            : widget.booking.sumOfServicePrices.validate() -
                                widget.booking.couponAmount.validate(),
              ...
              if (widget.booking.sumOfProductPrices != 0)
                SettingItemWidget(
                  ...
                  trailing: Marquee(
                    child: PriceWidget(
                        price: widget.booking.sumOfProductPrices.validate(),
                        color: textPrimaryColorGlobal,
                        size: 14),
                  ),
                ).paddingBottom(10),
              ...
              if (widget.booking.taxDetails != null)
                Column(
                  children: List.generate(
                    ...
                    (index) {
                      TaxDetail tax =
                          widget.booking.taxDetails.validate()[index];
              ...
              if (widget.booking.tip != 0)
                Row(
                  ...
                  children: [
                    ...
                    16.width,
                    PriceWidget(
                        price: widget.booking.tip.validate(),
                        color: textPrimaryColorGlobal,
                        size: 14),
                  ],
                ).paddingBottom(10),
              ...
              SettingItemWidget(
                ...
                trailing: Marquee(
                    child: PriceWidget(
                        price: subtotal == 0
                            ? 0
                            //   ? widget.booking.packages!.first.packagePrice
                            // .validate()
                            : widget.booking.totalAmount.validate(),
          ...
          Column(
            children: [
              ...
              Container(
                ...
                child: Column(
                  children: [
                    if (widget.booking.payment!.externalTransactionId
                        .validate()
                        .isNotEmpty)
                      Column(
                        children: [
                          CommonRowTextWidget(
                            ...
                            trailingText: widget
                                .booking.payment!.externalTransactionId
                                .validate(),
                            leftWidgetFlex: 3,
                            rightWidgetFlex: 7,
                          ),
                    ...
                    if (widget.booking.payment!.transactionType != null)
                      SettingItemWidget(
                        ...
                        trailing: Marquee(
                          child: Text(
                              widget.booking.payment!.transactionType
                                  .validate()
                    ...
                    SettingItemWidget(
                      ...
                      trailing: Marquee(
                        child: Text(
                            widget.booking.payment!.paymentStatus == 1
                                ? locale.paid
                                : locale.pending,
                            style: boldTextStyle(size: 14)),
                      ),
        ...
        else if (widget.booking.status == BookingStatusConst.COMPLETED &&
            (widget.booking.payment == null ||
                (widget.booking.payment != null &&
                    widget.booking.payment!.paymentStatus == 0)))
          Column(
            children: [
              16.height,
              AppButton(
                ...
                width: context.width(),
                onTap: () async {
                  bool? res = await CompletePaymentScreen(widget.booking)
                      .launch(context);
