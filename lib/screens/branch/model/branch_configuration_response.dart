...
class BranchConfigurationData {
  ...
  BranchConfigurationData(
      {this.slot, this.slotDuration, this.tax, this.reserved_periods});

  factory BranchConfigurationData.fromJson(Map<String, dynamic> json) {
    return BranchConfigurationData(
      reserved_periods: json['reserved_periods'],
      slot: json['slot'] != null
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.reserved_periods != null) {
      data['reserved_periods'] =
          this.reserved_periods; //!.map((e) => e).toList();
    }
    if (this.slot != null) {
