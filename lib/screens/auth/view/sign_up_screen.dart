...
import 'package:frezka/screens/auth/services/otp_login_auth_service.dart';
...
class _SignUpScreenState extends State<SignUpScreen> {
  ...
  void registerUser() async {
    ...
    if (formKey.currentState!.validate()) {
      ...
      appStore.setLoading(true);
      var pass = mobileCont.text.trim();
      if (pass.startsWith('07')) {
        pass = pass.replaceFirst('07', '9627');
      }
                  ...
                  children: [
                    ...
                    Positioned(
                      ...
                      child: Container(
                        ...
                        decoration:
                            boxDecorationDefault(shape: BoxShape.circle),
